  ...
  <div class="w-2/6 my-10">
    ...
    <div class="w-full p-6 mt-3 bg-white rounded-lg shadow-md text-center dark:bg-gray-800 dark:border-gray-700">
      <form class="flex flex-col gap-3">
        ...
        <button v-if="authenticated" type="button" class="text-white uppercase bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" @click="logout">
          Logout
        </button>
      </form>
    </div>
